 const seccionesPagina = new fullpage("#fullpage", {
	...
	anchors: ['Inicio', 'Productos', 'Contactos'], // Anclas, las usamos para identificar cada seccion y poder acceder a ellas con el menu.
	navigationTooltips: ['Inicio', 'Productos', 'Contactos'], // Tooltips que mostrara por cada boton.
    ...
    afterLoad: function name(origin, destination) {
